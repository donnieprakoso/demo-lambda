...
class DynamoDbStreams(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        fnLambda_captureData = _lambda.Function(
            self,
            "{}-function-captureData".format(id),
            code=_lambda.AssetCode("../lambda-functions/capture-data"),
            handler="app.handler",
        ...
        fnLambda_captureData.add_event_source(_lambdasources.DynamoEventSource(
            ddb_table, starting_position=_lambda.StartingPosition.LATEST))
        ...
        core.CfnOutput(self,
                       ...
                       value=fnLambda_captureData.function_name,
                       export_name="{}-lambdaFunctionName".format(id))


app = App()
DynamoDbStreams(app, "lambda-dynamodb-streams")
app.synth()
